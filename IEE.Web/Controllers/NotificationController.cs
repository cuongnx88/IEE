    ...
    public class NotificationController : Controller
    {
        ...
        public ActionResult Index(int? pageNum)
        {
            ...
            if (Request.IsAjaxRequest())
            {
                ...
                return PartialView("_Notification", posts);
            }
            else
            {
                LoadAllPostToSession(27);
        ...
        {
            Dictionary<int, Post> posts = (Session["Notification"] as Dictionary<int, Post>);
        ...
        private void LoadAllPostToSession(int? categoryId)
        {
            ...
            int custIndex = 1;
            Session["Notification"] = posts.OrderBy(t => t.OrderNumber).ThenByDescending(t => t.PublishedDate).ToDictionary(x => custIndex++, x => x);
